...
def song_cover_pipeline(song_input, voice_model, pitch_change, keep_files,
    ...
    try:
        ...
        # apply_effects = False, return original path
        else:
            ai_cover_path = ai_vocals_path
...
def simple_voice_conversion(song_input, voice_model, pitch_change, progress=gr.Progress()):
    try:
...
if simple:
    simple_path = simple_voice_conversion()
    print(f'[+] Simply conversed in {simple_path}')
    return
